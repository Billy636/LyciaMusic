...
const { init, showAddToPlaylistModal, playlistAddTargetSongs, addSongsToPlaylist } = usePlayer();
init();
...
<template>
  <div class="flex flex-col h-screen w-full text-gray-800 relative overflow-hidden font-sans">
    ...
    <div class="flex flex-1 overflow-hidden relative z-0">
      ...
      <div class="flex-1 flex flex-col min-w-0 bg-white/30 backdrop-blur-2xl transition-colors duration-500">
        <TitleBar />
