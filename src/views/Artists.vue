    ...
    <section class="flex-1 overflow-y-auto p-8 custom-scrollbar">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
        <div 
          ...
          class="group cursor-pointer bg-black/5 dark:bg-white/5 hover:bg-white dark:hover:bg-white/10 border border-transparent hover:border-gray-200 dark:hover:border-white/20 hover:shadow-lg rounded-xl p-4 transition-all duration-300 flex flex-col items-center text-center"
        >
          <!-- 头像占位符 (圆形) -->
